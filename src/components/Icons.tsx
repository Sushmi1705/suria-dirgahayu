...
export const BoltIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  ...
  >
    ...
    <path d="m13 10-4 6h3v4l4-6h-3V10Z" />
  </svg>
);
...
export const HammerIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    <path d="m15 5 4 4" />
    <path d="M21.5 2h-5.5v3l-5 5H8L3 15v3.5l1.5 1.5H8l5-5v-3l5-5h3z" />
...
export const PaintbrushIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="m12 22 1-1c1.4-1.4 2.4-3.2 3-5 .6-1.7 1-3.5 1-5.3V3c0-.6-.4-1-1-1H3c-.6 0-1 .4-1 1v8c0 1.8.4 3.6 1 5.3.6 1.8 1.6 3.6 3 5l1 1" />
    <path d="M12 17h10" />
    <path d="M16 12h6" />
    <path d="M18 7h4" />
  </svg>
...
export const DollarIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
